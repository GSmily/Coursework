...
look(X):-write('Name:\n'),name(X,N),write(N),
	write('\n\nLong Description:\n'),long_desc(X,L),write(L),
	write('\n\nConnection Names:\n'),show_connection_names(X),
	write('Connection Descriptions:\n'),show_connection_descriptions(X),
	write('Name of Contents:\n'),show_content_names(X),
	write('Description of Contents:\n'),show_content_descriptions(X).

study(X):-write('Object Description:\n'),long_desc(X,L),write(L),
	write('\n\nName of Contents:\n'),show_content_names(X),
	write('Description of Contents:\n'),show_content_descriptions(X).